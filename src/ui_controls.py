...
class Button:
    ...
    def button_update_state(self, handle_click_event):
...
class Box:
    def __init__(self, x, y, item):
        ...
        self.y = y
        self.text = item
        self.box_container = pygame.image.load(r"D:\Projects\Python-studies\shop_shop_manager\images\box.png")
        self.rect = self.box_container.get_rect(topleft=(x, y))

        
    def box_draw(self, screen):
        screen.blit(self.box_container, self.rect.topleft)
